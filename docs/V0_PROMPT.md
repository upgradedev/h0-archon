...
> - **Payroll controls** (true employer cost vs bank transfer, the hidden €3,154/28% wedge) — one module, not the headline.
> - **Document intake** (multi-type coverage chips), **seven-agent run ledger**, **source citations**, **Ask-Archon Q&A** input.
