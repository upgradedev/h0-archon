...
const ledger = [
  { label: "Revenue", value: "€47,200", trend: "+8.2%", up: true },
  { label: "Cost of sales", value: "€1,072", trend: "-2.1%", up: false },
  { label: "Gross profit", value: "€46,128", trend: "+12.4%", up: true },
  { label: "Operating expenses", value: "€15,430", trend: "+1.6%", up: false },
]
    ...
    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-2xl shadow-foreground/10">
      ...
      <div className="flex items-center justify-between border-b border-border bg-secondary/50 px-4 py-3">
        ...
        <div className="flex items-center gap-2 rounded-md bg-card px-3 py-1 text-xs text-muted-foreground">
          ...
          Monthly close · January 2026 · finalized
        </div>
      ...
      <div className="grid gap-px bg-border md:grid-cols-5">
        ...
        <div className="bg-card p-6 md:col-span-2">
          ...
          <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
            ...
            <span className="text-sm font-semibold tabular-nums">€79,498</span>
          </div>
        </div>
      </div>
    </div>
